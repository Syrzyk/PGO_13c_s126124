...
public class Main {
    public static void main(String[] args){
        ...
        Book book1 =  new Book("Band of Brothers",Genre.Classic, Lang.English, LocalDate.of(1992,10,12) );
        Book book2 = new Book( "Little Women",Genre.Fiction, Lang.English, LocalDate.of(1868,1,1) );
        Book book3 = new Book( "Chorna Rada: The Black Council",Genre.Classic, Lang.Ukrainian, LocalDate.of(2013,9,29) );

        // Publishing book by author
        person2.addBook(new Book("Diune", Genre.Adventure, Lang.Polish,LocalDate.of(2011,7,21)));
